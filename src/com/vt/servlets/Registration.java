...
public class Registration extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse resp) throws ServletException, IOException {
		...
		session.getAttribute(Authorization.USER_ACCESS_GRANTED);

		String form = "<html><div style=\"width: 50%; height: 100px; float: left;\"> \r\n"
				+ "            <form action=\"\" method='post'>\r\n" + "			   <table border=\"0\">\r\n"
				+ "				  <tr>\r\n" + "					 <td width=\"100\">Login</td>\r\n"
				+ "					 <td ><input type=\"email\" name=\"login\" value=\"" + (login != null ? login : " ")
				+ "\"/></td>\r\n" + "				  </tr>\r\n" + "				  <tr>\r\n"
				+ "					 <td>Password</td>\r\n"
				...
				+ (fullName != null ? fullName : " ") + "\"/></td>\r\n" + "				  </tr>\r\n"
				+ "				  <tr>\r\n" + "					 <td>Region</td>\r\n" + "					 <td>\r\n"
				+ "						 <select name = \"region\">\r\n"
				+ "						 <option value = \"Lviv\"" + ("Lviv".equals(region) ? "selected" : " ")
				+ ">Lviv region</option>\r\n" + "						 <option value = \"Kyiv\""
				+ ("Kyiv".equals(region) ? "selected" : " ") + ">Kyiv region</option>\r\n"
				+ "						 <option value = \"Kharkiv\"" + ("Kharkiv".equals(region) ? "selected" : " ")
				+ ">Kharkiv region</option>\r\n" + "						 </select>\r\n"
				+ "					 </td>\r\n" + "				  </tr>\r\n" + "				  <tr>\r\n"
				+ "					 <td>Gender</td>\r\n" + "						<td>\r\n"
				...
				+ "				  </tr>\r\n" + "				  <tr>\r\n" + "					 <td>Comment</td>\r\n"
				+ "						<td>\r\n"
				+ "							<textarea cols = \"10\" rows = \"5\" name = \"comment\">"
				+ (comment != null ? comment : " ") + "</textarea>\r\n" + "						</td>\r\n"
				+ "				  </tr>\r\n" + "				  <tr>\r\n"
